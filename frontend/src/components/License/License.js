  ...
  return (
    <div className="License">
      <div className="License-container">
        <h1>Open Gaming License</h1>
        <p className="Explain">
          At Krakensheet, we use content provided by the OGL like feats, traits,
          classes, and spells. For each piece of OGL licensed content we
          distribute, the copyright notice is included underneath. Below, we
          include a copy of the OGL.
        </p>
        <p>
        ...
        <p>
          See{' '}
          <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vRzqlSOt_PWWzLu2e3wFbjpcso8FdEcRG72AABG_jOHx3-AW5i_yb2rtHlirlaLMF6UGsswj3wcyIOE/pub?output=pdf">
            this PDF
          </a>{' '}
          for a full listing of copyright information
        </p>
      </div>
    </div>
  );
